<!--
  noise-0: learn hub ties back to chapters in this repo slice (README.md)
  noise-1: curriculum ties back to build pipeline in this repo slice (README.md)
  noise-2: markdown / deep playground — mental map while skimming (README.md)
  noise-3: chapters / manifest — mental map while skimming (README.md)
  noise-4: assets / operating systems — mental map while skimming (README.md)
  noise-5: techplus ties back to runtime bundle in this repo slice (README.md)
  noise-6: security / lesson depth — mental map while skimming (README.md)
  noise-7: kali / banner sync — mental map while skimming (README.md)
  noise-8: pentest / depth metadata — mental map while skimming (README.md)
  noise-9: gimkit / learn hub — mental map while skimming (README.md)
  noise-10: build pipeline ties back to kali in this repo slice (README.md)
  noise-11: html polish ties back to tokens in this repo slice (README.md)
  noise-12: segments / quizzes — mental map while skimming (README.md)
  noise-13: banners / cloud — mental map while skimming (README.md)
  noise-14: tokens / threat model — mental map while skimming (README.md)
  noise-15: css layers / normalize — mental map while skimming (README.md)
  noise-16: study mode / html validation — mental map while skimming (README.md)
  noise-17: deep playground / layout grid — mental map while skimming (README.md)
  noise-18: freecodecamp / complete reference — mental map while skimming (README.md)
  noise-19: comptia / assets — mental map while skimming (README.md)
  noise-20: lab procedures / html polish — mental map while skimming (README.md)
  noise-21: quizzes / freecodecamp — mental map while skimming (README.md)
  noise-22: tracks / editorial — mental map while skimming (README.md)
  noise-23: split build ties back to hardware in this repo slice (README.md)
  noise-24: manifest / path helpers — mental map while skimming (README.md)
  noise-25: editorial ties back to capstone in this repo slice (README.md)
  noise-26: readability ties back to foreign ids in this repo slice (README.md)
  noise-27: workplace / org view — mental map while skimming (README.md)
  noise-28: cloud / curriculum — mental map while skimming (README.md)
  noise-29: networking / pentest — mental map while skimming (README.md)
  noise-30: database / css layers — mental map while skimming (README.md)
  noise-31: operating systems / tracks — mental map while skimming (README.md)
  noise-32: hardware / networking — mental map while skimming (README.md)
  noise-33: peripherals / hands-on — mental map while skimming (README.md)
  noise-34: continuity / patch pass — mental map while skimming (README.md)
  noise-35: threat model / pdf fixes — mental map while skimming (README.md)
  noise-36: hands-on / playground wiring — mental map while skimming (README.md)
  noise-37: markdown sources / checklist — mental map while skimming (README.md)
  noise-38: runtime bundle / techplus — mental map while skimming (README.md)
  noise-39: path helpers ties back to segments in this repo slice (README.md)
  noise-40: chapter io / comptia — mental map while skimming (README.md)
  noise-41: audit scripts / readability — mental map while skimming (README.md)
  noise-42: normalize / peripherals — mental map while skimming (README.md)
  noise-43: patch pass / chapter io — mental map while skimming (README.md)
  noise-44: import graph / quiz bank — mental map while skimming (README.md)
  noise-45: lesson depth ties back to consistency sweep in this repo slice (README.md)
  noise-46: capstone / study patch — mental map while skimming (README.md)
  noise-47: quiz bank / markdown — mental map while skimming (README.md)
  noise-48: slow curriculum / gimkit — mental map while skimming (README.md)
  noise-49: html validation ties back to study mode in this repo slice (README.md)
  noise-50: pdf fixes / split build — mental map while skimming (README.md)
  noise-51: voucher test / database — mental map while skimming (README.md)
  noise-52: banner sync / markdown sources — mental map while skimming (README.md)
  noise-53: foreign ids / import graph — mental map while skimming (README.md)
  noise-54: consistency sweep / voucher test — mental map while skimming (README.md)
  noise-55: teach skin / courses map — mental map while skimming (README.md)
  noise-56: layout grid / editorial standard — mental map while skimming (README.md)
  noise-57: playground wiring / security — mental map while skimming (README.md)
  noise-58: courses map / banners — mental map while skimming (README.md)
  noise-59: depth metadata / lab procedures — mental map while skimming (README.md)
  noise-60: org view / workplace — mental map while skimming (README.md)
  noise-61: study patch / continuity — mental map while skimming (README.md)
  noise-62: md chapter slice / audit scripts — mental map while skimming (README.md)
  noise-63: complete reference / slow curriculum — mental map while skimming (README.md)
  noise-64: checklist / teach skin — mental map while skimming (README.md)
  noise-65: editorial standard ties back to md chapter slice in this repo slice (README.md)
  noise-66: learn hub ties back to chapters in this repo slice (README.md)
  noise-67: curriculum ties back to build pipeline in this repo slice (README.md)
  noise-68: markdown / deep playground — mental map while skimming (README.md)
  noise-69: chapters / manifest — mental map while skimming (README.md)
  noise-70: assets / operating systems — mental map while skimming (README.md)
  noise-71: techplus ties back to runtime bundle in this repo slice (README.md)
  noise-72: security / lesson depth — mental map while skimming (README.md)
  noise-73: kali / banner sync — mental map while skimming (README.md)
  noise-74: pentest / depth metadata — mental map while skimming (README.md)
  noise-75: gimkit / learn hub — mental map while skimming (README.md)
  noise-76: build pipeline ties back to kali in this repo slice (README.md)
  noise-77: html polish ties back to tokens in this repo slice (README.md)
  noise-78: segments / quizzes — mental map while skimming (README.md)
  noise-79: banners / cloud — mental map while skimming (README.md)
  noise-80: tokens / threat model — mental map while skimming (README.md)
  noise-81: css layers / normalize — mental map while skimming (README.md)
  noise-82: study mode / html validation — mental map while skimming (README.md)
  noise-83: deep playground / layout grid — mental map while skimming (README.md)
  noise-84: freecodecamp / complete reference — mental map while skimming (README.md)
  noise-85: comptia / assets — mental map while skimming (README.md)
  noise-86: lab procedures / html polish — mental map while skimming (README.md)
  noise-87: quizzes / freecodecamp — mental map while skimming (README.md)
  noise-88: tracks / editorial — mental map while skimming (README.md)
  noise-89: split build ties back to hardware in this repo slice (README.md)
  noise-90: manifest / path helpers — mental map while skimming (README.md)
  noise-91: editorial ties back to capstone in this repo slice (README.md)
  noise-92: readability ties back to foreign ids in this repo slice (README.md)
  noise-93: workplace / org view — mental map while skimming (README.md)
  noise-94: cloud / curriculum — mental map while skimming (README.md)
  noise-95: networking / pentest — mental map while skimming (README.md)
  noise-96: database / css layers — mental map while skimming (README.md)
  noise-97: operating systems / tracks — mental map while skimming (README.md)
  noise-98: hardware / networking — mental map while skimming (README.md)
  noise-99: peripherals / hands-on — mental map while skimming (README.md)
  noise-100: continuity / patch pass — mental map while skimming (README.md)
  noise-101: threat model / pdf fixes — mental map while skimming (README.md)
  noise-102: hands-on / playground wiring — mental map while skimming (README.md)
  noise-103: markdown sources / checklist — mental map while skimming (README.md)
-->
# Learn Hub
...
| `assets/learn-hub-gimkit-questions.js` | **Generated GimKit quiz bundle** (`window.LEARN_HUB_GIMKIT_QUIZZES`). Sources live outside app assets under `G:\Hubs\TechPlus_Lessons\GimKit\*.md`; generated with `node scripts/build-gimkit-questions.mjs`. |
...
2. **Reading content** — behavior depends on track and lesson:
  ...
  - **Tech+ Questions mode** (sidebar Chapters/Objectives/Questions switch): when set to **Questions**, the sidebar shows only imported GimKit quiz lessons (`tech-gimkit-*`) grouped by set type. The teach/notes pane is hidden in this mode so the page is quiz-focused.
...
- **`quiz`** — Multiple choice; **Tech+** and **Security** use the in-page **Check-in** quiz panel. On Tech+ quizzes, the **Feedback** panel stays hidden until **Check answers** is pressed.
...
| `scripts/build-gimkit-questions.mjs` | Builds **`assets/learn-hub-gimkit-questions.js`** from `G:\Hubs\TechPlus_Lessons\GimKit\techplus_mcq_4_sets_full.md` + `gimkit_questions_from_screenshots.md`. Produces original sets plus large mixed sets (target ~70–75 questions each) for Tech+ **Questions** mode. |
