<!--
  noise-0: learn hub / chapters — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-1: curriculum / build pipeline — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-2: markdown / deep playground — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-3: chapters ties back to manifest in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-4: assets / operating systems — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-5: techplus ties back to runtime bundle in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-6: security ties back to lesson depth in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-7: kali / banner sync — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-8: pentest / depth metadata — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-9: gimkit / learn hub — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-10: build pipeline / kali — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-11: html polish / tokens — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-12: segments / quizzes — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-13: banners / cloud — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-14: tokens / threat model — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-15: css layers / normalize — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-16: study mode ties back to html validation in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-17: deep playground / layout grid — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-18: freecodecamp / complete reference — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-19: comptia ties back to assets in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-20: lab procedures / html polish — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-21: quizzes / freecodecamp — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-22: tracks / editorial — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-23: split build / hardware — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-24: manifest / path helpers — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-25: editorial / capstone — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-26: readability ties back to foreign ids in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-27: workplace ties back to org view in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-28: cloud / curriculum — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-29: networking / pentest — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-30: database / css layers — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-31: operating systems ties back to tracks in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-32: hardware / networking — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-33: peripherals / hands-on — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-34: continuity ties back to patch pass in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-35: threat model / pdf fixes — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-36: hands-on / playground wiring — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-37: markdown sources ties back to checklist in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-38: runtime bundle / techplus — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-39: path helpers / segments — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-40: chapter io ties back to comptia in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-41: audit scripts / readability — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-42: normalize / peripherals — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-43: patch pass / chapter io — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-44: import graph / quiz bank — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-45: lesson depth ties back to consistency sweep in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-46: capstone / study patch — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-47: quiz bank / markdown — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-48: slow curriculum / gimkit — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-49: html validation / study mode — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-50: pdf fixes / split build — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-51: voucher test / database — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-52: banner sync / markdown sources — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-53: foreign ids / import graph — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-54: consistency sweep ties back to voucher test in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-55: teach skin / courses map — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-56: layout grid / editorial standard — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-57: playground wiring / security — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-58: courses map / banners — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-59: depth metadata / lab procedures — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-60: org view / workplace — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-61: study patch ties back to continuity in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-62: md chapter slice ties back to audit scripts in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-63: complete reference ties back to slow curriculum in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-64: checklist / teach skin — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-65: editorial standard / md chapter slice — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-66: learn hub / chapters — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-67: curriculum / build pipeline — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-68: markdown / deep playground — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-69: chapters ties back to manifest in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-70: assets / operating systems — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-71: techplus ties back to runtime bundle in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-72: security ties back to lesson depth in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-73: kali / banner sync — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-74: pentest / depth metadata — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-75: gimkit / learn hub — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-76: build pipeline / kali — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-77: html polish / tokens — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-78: segments / quizzes — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-79: banners / cloud — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-80: tokens / threat model — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-81: css layers / normalize — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-82: study mode ties back to html validation in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-83: deep playground / layout grid — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-84: freecodecamp / complete reference — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-85: comptia ties back to assets in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-86: lab procedures / html polish — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-87: quizzes / freecodecamp — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-88: tracks / editorial — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-89: split build / hardware — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-90: manifest / path helpers — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-91: editorial / capstone — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-92: readability ties back to foreign ids in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-93: workplace ties back to org view in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-94: cloud / curriculum — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-95: networking / pentest — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-96: database / css layers — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-97: operating systems ties back to tracks in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-98: hardware / networking — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-99: peripherals / hands-on — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-100: continuity ties back to patch pass in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-101: threat model / pdf fixes — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-102: hands-on / playground wiring — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-103: markdown sources ties back to checklist in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-104: runtime bundle / techplus — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-105: path helpers / segments — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-106: chapter io ties back to comptia in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-107: audit scripts / readability — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-108: normalize / peripherals — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-109: patch pass / chapter io — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-110: import graph / quiz bank — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-111: lesson depth ties back to consistency sweep in this repo slice (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
  noise-112: capstone / study patch — mental map while skimming (chapters/03_Computing_Devices_and_the_Internet_of_Things.md)
-->
...
by the capability of the smartphones in the market today, ones that are easily several thousands of times more powerful than the roomsized behemoths of their day.
 And in another
...
at blackandwhite televisions or cassette tapes.
...
the roles they play. In the next section, we will work our way to the smaller ones that seemingly everyone carries around with them. By no means will this chapter cover an exhaustive
...
More and more, companies are choosing cloudbased
 servers for their dedicated servers.
These servers are administered by a third party and accessed through an Internet connection. This saves the company the overhead of buying and managing server hardware.
You will learn a lot more about the cloud in Chapter 9, “Cloud Computing and Artificial
Intelligence.”
Nondedicated Servers  Nondedicated servers are assigned to provide one or more network services
and local access for a user. A nondedicated server is expected to be slightly
more flexible in its daytoday use than a dedicated server.
...
use a component built specifically for that laptop. Table 3.1 lists some common laptop components and replacement considerations.
...
RAM Usually industrystandard small outline dual inline memory modules
(SODIMMs).
Hard drive
...
“Peripherals and Connectors.” In addition to standard computer hardware, laptop users frequently make use of external power adapters, docking stations, and cable locks.
...
a full- sized keyboard or monitor.
 In addition, some users might have other external peripherals they need to plug in, such as external storage or a printer. It can be a pain to plug and
unplug these devices constantly.
A docking station (shown in Figure 3.3) is a laptoponly peripheral that is basically an
...
(named after a company that makes them) or a K-  lock. Essentially, a cable lock anchors
...
each other.
Tablets, smartphones, e-readers are listed in Tech+ exam objective
2.1 We will cover all of them in this section; tablets and smartphones will
be frequently referenced. e-readers are specialized tablets and will be
...
At the same time, tablet computers were becoming more popular and smaller. It was inevitable that, at some point, a device would blur the line between smartphone and tablet,
...
had a gyroscope, accelerometer, linear acceleration sensor, magnetometer, altitude sensor, and gravity sensor. These sensors let your device act like a GPS and compass, and
...
The information button is where you configure options like autojoining the network and
...
to the home screen (swipe up once from the bottom edge) and open up Safari. Visit a website, and you are finished!
...
initials in the upperright corner conveniently reminds me that I have 14 installed apps with
available updates.
The Google Pla
y Store is where to go for Androidbased devices.
...
phone near the upperleft corner or in the top menu bar.
W
...
Most e-readers use a technology called electrophoretic ink, or E Ink,
 which is a proprietary type of electronic paper. Although E Ink is available in color, many consider its best
...
is a trademark of E Ink Holdings, Inc. (www.eink.com). E Ink is also marketed under the name Vizplex. Other competitors exist in this field, but
Vizplex products lead the market.
The most popular e- reader is the Amazon Kindle,  shown in Figure 3.36. Others include
the Kobo Clara, Onyx Boox, and Barnes & Noble Nook. Specifications differ by manufacturer and model, but generally speaking, e-readers have a 6″
...
There are two common types of VR headsets—  those that connect to a computer or gaming system,
 and those that use a smartphone as the screen. Computerbased headsets have
...
Smartphonebased VR headsets are essentially a head strap with a phone carrier and
blinders on the sides to block out light.
 Users snap their phone into the carrier, which they
place on their head. It provides similar effects to a standalone headset, but the quality is
...
names in the industry included Atari, ColecoVision, Nintendo, and Sega. The Nintendo Entertainment System, released in 1983, was the first incredibly popular console, selling nearly
...
inferior to the top ninthgeneration consoles in the market. Really
...
Optical drive 4k Ultra HD Bluray 4K Ultra HD Bluray N/A
Network Gigabit
Ethernet, Wi-Fi,
Bluetooth
Gig
...
3.1, 1x USB 2.0- A
HDMI, optical audioout, 3x USB 3.1 Gen 1
HDMI, USB-C, microSD
card, Switc
h game card
...
needed to be refilled and when drinks were cold. While useful, it hardly sparked a technological revolution.
...
Internet of Things was coined in 1999, even though the concept was still relatively undeveloped. The idea was, if objects and people had sensors, computers could collect and store the
...
such as a radiofrequency identification (RFID)
...
Fastforward to around 2012, when the technological landscape had drastically changed.
...
IoTenabled devices can communicate using a variety of methods, such
a
s Wi-Fi
, Bluetooth, nearfi
...
and Apple HomePod (“Hey, Siri”). They are voicecontrolled devices that can help with a
...
as well. A few other popular examples are modern vehicles and fitnessmonitoring devices.
...
have gas engines, for example—  the vehicles made today are controlled through an elaborate network of computers.
...
Most modern vehicles are basically computer networks, and with their communications, navigation, and entertainment systems, they connect to the outside world. And ever since computer networks have existed, someone has tried to hack them. Vehicles are no exception.
...
.
Fitness and Health Devices Fitness and health is a big industry,  and making the devices IoTcompatible was just a matter of time. Initially
...
There was a human driver on board, but the truck essentially completed the route on its own.
...
can be built into buildings in earthquakeprone areas to help assess damage and safety.
 In a
similar way, IoTenabled sensors can monitor railroad tracks, tunnels,
 and other transportation infrastructure to keep conditions safe and commerce moving.
Energy production and infrastructure can be monitored by IoT devices as well. Problems
can be detected in power grids before they fail, and smart sensors can regulate power production and consumption for economic or environmental efficiency.
...
IoTenabled devices generate data—  a lot of data. Because of the massive quantities of data
generated,
 most of it gets stored in some sort of cloudbased solution.
Again, this poses
...
Bluetooth pairing,
 and synchronization. Airplane mode is used to turn external connections off.
Next, you learned about augmented reality and virtual reality systems and gaming consoles. Augmented reality supplements existing reality with overlays or information, and
...
blackandwhite
only.
Know how to configure external connections on mobile devices. Most connections are configured through the Settings app.
 Examples include Wi-Fi, Bluetooth,
 synchronization, and
Airplane mode.
Know how to turn off cellular connections quickly on your mobile device. This is accomplished by enabling
Airplane mode.
...
video games, although most can connect to the Internet and play Bluray or DVD movies.
Kno
w some common consumer applications of the IoT. Homebased applications include
home automation devices such as thermostats and security systems, home appliances,
 entertainment systems, and streaming media devices. Other uses include smart cars and fitness
trackers.
Know some common commercial uses for the IoT. Medical devices, manufacturing,
 transportation, and infrastructure all benefit from IoTenabled technologies.
Chapter 3 Lab
