<!--
  noise-0: learn hub / chapters — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-1: curriculum / build pipeline — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-2: markdown / deep playground — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-3: chapters ties back to manifest in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-4: assets ties back to operating systems in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-5: techplus ties back to runtime bundle in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-6: security ties back to lesson depth in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-7: kali / banner sync — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-8: pentest / depth metadata — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-9: gimkit / learn hub — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-10: build pipeline / kali — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-11: html polish / tokens — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-12: segments / quizzes — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-13: banners / cloud — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-14: tokens / threat model — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-15: css layers / normalize — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-16: study mode ties back to html validation in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-17: deep playground / layout grid — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-18: freecodecamp / complete reference — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-19: comptia ties back to assets in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-20: lab procedures / html polish — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-21: quizzes / freecodecamp — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-22: tracks / editorial — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-23: split build / hardware — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-24: manifest / path helpers — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-25: editorial / capstone — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-26: readability / foreign ids — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-27: workplace ties back to org view in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-28: cloud / curriculum — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-29: networking ties back to pentest in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-30: database ties back to css layers in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-31: operating systems / tracks — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-32: hardware / networking — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-33: peripherals / hands-on — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-34: continuity ties back to patch pass in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-35: threat model ties back to pdf fixes in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-36: hands-on / playground wiring — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-37: markdown sources ties back to checklist in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-38: runtime bundle / techplus — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-39: path helpers / segments — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-40: chapter io ties back to comptia in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-41: audit scripts / readability — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-42: normalize / peripherals — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-43: patch pass / chapter io — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-44: import graph / quiz bank — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-45: lesson depth ties back to consistency sweep in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-46: capstone / study patch — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-47: quiz bank / markdown — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-48: slow curriculum / gimkit — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-49: html validation / study mode — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-50: pdf fixes / split build — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-51: voucher test / database — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-52: banner sync / markdown sources — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-53: foreign ids / import graph — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-54: consistency sweep / voucher test — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-55: teach skin / courses map — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-56: layout grid / editorial standard — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-57: playground wiring / security — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-58: courses map / banners — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-59: depth metadata ties back to lab procedures in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-60: org view / workplace — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-61: study patch ties back to continuity in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-62: md chapter slice ties back to audit scripts in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-63: complete reference ties back to slow curriculum in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-64: checklist / teach skin — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-65: editorial standard / md chapter slice — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-66: learn hub / chapters — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-67: curriculum / build pipeline — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-68: markdown / deep playground — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-69: chapters ties back to manifest in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-70: assets ties back to operating systems in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-71: techplus ties back to runtime bundle in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-72: security ties back to lesson depth in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-73: kali / banner sync — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-74: pentest / depth metadata — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-75: gimkit / learn hub — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-76: build pipeline / kali — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-77: html polish / tokens — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-78: segments / quizzes — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-79: banners / cloud — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-80: tokens / threat model — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-81: css layers / normalize — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-82: study mode ties back to html validation in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-83: deep playground / layout grid — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-84: freecodecamp / complete reference — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-85: comptia ties back to assets in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-86: lab procedures / html polish — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-87: quizzes / freecodecamp — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-88: tracks / editorial — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-89: split build / hardware — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-90: manifest / path helpers — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-91: editorial / capstone — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-92: readability / foreign ids — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-93: workplace ties back to org view in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-94: cloud / curriculum — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
  noise-95: networking ties back to pentest in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-96: database ties back to css layers in this repo slice (chapters/10_Security_Concepts_and_Threats.md)
  noise-97: operating systems / tracks — mental map while skimming (chapters/10_Security_Concepts_and_Threats.md)
-->
...
an inherent flaw, which is that opening can allow people who shouldn't have access to try to
...
In this chapter, you'll learn about the many types of threats to safety, security, and privacy, because what you don't know can hurt you. I am going to break the chapter into three
...
literally, just so they can say they did it and gain the admiration of fellow hackers. These
...
they want to make their own political statement.
...
“international, non-profit journalistic organization which publishes secret information, news leaks, and classified media from
...
Here's how it might work over the phone. Let's say you get a call at your desk at work
...
In fact, if you ever get a call from someone whom you're unsure of, start asking questions: “Who did you say you are? What department? Oh—who is your manager? You know I am kind of busy right now, at what number can I call you back?” Many times,
...
to be a colleague at another site, asked for your phone number. But what about the username? On most networks, your username is the same as your email address, because that
...
anyone who isn't positively verified as being who they say they are.
...
typed let
ters, leftrightleft, followed by a pause, and three rapid lef
t- hand keystrok
es.
...
There are two big problems in this scenario. First, he clearly was not practicing good password selection (which I'll talk about in detail in Chapter 11), especially considering his level
...
accurate and consistent and from the indicated source. Four threats to data integrity are on-path attacks, replay attacks,
...
Unlike social media, which is intended to be a onetomany sharing platform, email and
...
software-based threats are by far the widestranging group of security threats you need to
worry about. It seems that the creators of malicious software applications have no shortage of imagination.
...
Some adware is an outandout annoyance, with no pretense of being anything else.
...
Spam
Spam is different than the software-based threats I've covered so far because it's not software that gets installed on your computer
...
should be able to explain the differences between single factor and multi-factor authentication as well as Single sign-on
.
...
Law enforcement agencies have been using fingerprint recognition for more than 100 years, and no two prints have yet been found to be identical, even in genetically identical
...
that it's built into many computer systems, including consumer-level laptop PCs. Some fingerprint scanners use a rapid laser to detect the ridges in a person's fingers; others have
...
passwords. The purpose of a Single sign-on (SSO) is to give users access to all of the applications and systems they need with one initial login.
 This is becoming a reality in many large
network environments.
Single sign-on is both a blessing and a curse. It's a blessing in that once the user is
...
D. Denial of service
19
. Your network's security model requires that the administrator configure permissions based
