<!--
  noise-0: learn hub / chapters — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-1: curriculum / build pipeline — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-2: markdown / deep playground — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-3: chapters ties back to manifest in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-4: assets / operating systems — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-5: techplus ties back to runtime bundle in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-6: security / lesson depth — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-7: kali / banner sync — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-8: pentest / depth metadata — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-9: gimkit / learn hub — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-10: build pipeline ties back to kali in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-11: html polish / tokens — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-12: segments / quizzes — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-13: banners / cloud — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-14: tokens / threat model — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-15: css layers / normalize — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-16: study mode ties back to html validation in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-17: deep playground / layout grid — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-18: freecodecamp / complete reference — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-19: comptia ties back to assets in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-20: lab procedures / html polish — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-21: quizzes / freecodecamp — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-22: tracks / editorial — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-23: split build / hardware — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-24: manifest / path helpers — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-25: editorial / capstone — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-26: readability / foreign ids — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-27: workplace ties back to org view in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-28: cloud ties back to curriculum in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-29: networking ties back to pentest in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-30: database / css layers — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-31: operating systems / tracks — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-32: hardware / networking — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-33: peripherals / hands-on — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-34: continuity ties back to patch pass in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-35: threat model / pdf fixes — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-36: hands-on / playground wiring — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-37: markdown sources ties back to checklist in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-38: runtime bundle / techplus — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-39: path helpers / segments — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-40: chapter io ties back to comptia in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-41: audit scripts / readability — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-42: normalize / peripherals — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-43: patch pass / chapter io — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-44: import graph / quiz bank — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-45: lesson depth ties back to consistency sweep in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-46: capstone / study patch — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-47: quiz bank / markdown — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-48: slow curriculum / gimkit — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-49: html validation / study mode — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-50: pdf fixes / split build — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-51: voucher test / database — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-52: banner sync / markdown sources — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-53: foreign ids / import graph — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-54: consistency sweep / voucher test — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-55: teach skin / courses map — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-56: layout grid / editorial standard — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-57: playground wiring / security — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-58: courses map / banners — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-59: depth metadata / lab procedures — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-60: org view / workplace — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-61: study patch ties back to continuity in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-62: md chapter slice ties back to audit scripts in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-63: complete reference ties back to slow curriculum in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-64: checklist / teach skin — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-65: editorial standard / md chapter slice — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-66: learn hub / chapters — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-67: curriculum / build pipeline — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-68: markdown / deep playground — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-69: chapters ties back to manifest in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-70: assets / operating systems — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-71: techplus ties back to runtime bundle in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-72: security / lesson depth — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-73: kali / banner sync — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-74: pentest / depth metadata — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-75: gimkit / learn hub — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-76: build pipeline ties back to kali in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-77: html polish / tokens — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-78: segments / quizzes — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-79: banners / cloud — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-80: tokens / threat model — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-81: css layers / normalize — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-82: study mode ties back to html validation in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-83: deep playground / layout grid — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-84: freecodecamp / complete reference — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-85: comptia ties back to assets in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-86: lab procedures / html polish — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-87: quizzes / freecodecamp — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-88: tracks / editorial — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-89: split build / hardware — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-90: manifest / path helpers — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-91: editorial / capstone — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-92: readability / foreign ids — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-93: workplace ties back to org view in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-94: cloud ties back to curriculum in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-95: networking ties back to pentest in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-96: database / css layers — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-97: operating systems / tracks — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-98: hardware / networking — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-99: peripherals / hands-on — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-100: continuity ties back to patch pass in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-101: threat model / pdf fixes — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-102: hands-on / playground wiring — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-103: markdown sources ties back to checklist in this repo slice (chapters/08_Networking_Concepts_and_Technologies.md)
  noise-104: runtime bundle / techplus — mental map while skimming (chapters/08_Networking_Concepts_and_Technologies.md)
-->
...
connections.
 Although this is still possible, dialup is rarely used anymore because of the
prevalence of broadband options. In addition,
 dialup is painfully slow because of limitations on modem speed,
...
sense in modem manufacturers trying to exceed this threshold.) Dialup uses modems that
...
DSL connection.
There are actually several different forms of DSL, including high bitrate DSL (HDSL),
...
Conversely, new construction might have fiberop
tic cabling but no
...
- The cost is higher. Lowerspeed packages often start off at around $30 to $40 per month,
...
The other half of the popular homebroadband duet is the cable modem. These provide
...
neighborhoodsized group of homes. Everyone shares the available bandwidth.

 During peak times, your access speed may slow down.
- The cost is higher. Lowerspeed packages often start off at around $20 to $30 per
...
a router or wireless router just like a DSL modem. Therefore, you can share an Internet connection over a cable modem.
...
really starting to embrace its destiny. Many telephone and media companies offer fiberoptic
Internet connections for home subscribers.

An example of one such option is Fios, offered by Verizon. It offers FibertotheHome
(FTTH) service,
...
cameras, and link back to the station. (It was a network with TV cameras instead of workstations!) Because of the remote location, the crew had to set up a satellite uplink to get
...
and two others would board ATVs and journey up the remote mountainside. Once in position, they would set up the relay station, which looked a lot like a keg of beer with a few
...
about 500 Kbps downloads, and 4G enhancements over time increased that to a respectable 100 Mbps. With 5G, users can currently get up to 1 Gbps downloads, and major cellular providers are always looking for ways to increase that.
...
1 Gbps. The cost generally starts off at around $40–$60 per month, and you may get a discount if you bundle your cellular service with it.
...
factor in something very important: what is available in your area? DSL is available at different rates of connectivity based on distance from a central station. If you live far enough
...
Dialup Up to 56 Kbps Plain old telephone service.
A regular analog
phone line.
...
Fiberoptic Around 2 Gbps Incredibly fast and more expensi
ve than DSL
or cable.
...
In 1990, the Ethernet specification called for transmissions of 10 Mbps over twistedpair
...
The effects include shortened distances that electrical signals can travel or lower transmission speeds. Fiber is immune to those effects.
...
To summarize this section and explicitly bring it back to exam objectives, remember the following:

- The three newest standards, from oldest to newest, are 802.11n, 802.11ac (Wi-Fi 5), and 802.11ax (Wi-Fi 6).

As standards get newer, they provide faster speeds. Wi-Fi 7 is out but is not currently listed in the Tech+ Exam objectives.

- As a rule of thumb, higher frequencies (e.g., 6 GHz versus 2.4 GHz) will have higher throughput rates, but shorter distances and are more susceptible to attenuation.

- Interference from other devices broadcasting on the same frequency as a Wi-Fi network and natural signal attenuation will shorten maximum distances.
...
waves but shorter than microwaves. The most common use of infrared technology is the television remote control, although infrared is also used in nightvision goggles and medical and
scientific imaging.
In 1993, the
Infrared Data Association (IrDA) was formed as a technical consortium to
support “interoperable, low- cost infrared data interconnection standards that support a walkup, pointtopoint user model.”
...
does not use radio waves, there are no concerns of interference or signal conflicts. Atmospheric conditions can play a role in disrupting infrared waves, but considering that the
...
elevision
and other consumer electronics remote controls are not governed by IrDA. They use a different infrared technology, based on the RC- 5 protocol developed by Philips in the late
1980s.
...
There are two types of firewalls: networkbased and hostbased. A networkbased firewall is designed to protect a whole network of computers and almost always is a hardware
...
alls separate public versus private networks and can also create a screened
 subnet. Most networkbased firewalls have at least two network connections: one to the Internet,
or public side,
...
have gotten much faster thanks to broadband and fiberoptic Internet.
...
able to classify a network based on the location of the site or sites and the speed of the connection between them.
...
file downloads.
POP3, IMAP, and SMTP are all email protocols. POP3 and IMAP are used to receive (download) email, and SMTP is used to send email.
...
Command Prompt.
2. At the prompt, type ipconfig and press Enter. This will display the IP configuration information for your computer. Can you find your IP address, subnet mask, and
(optional) default gateway?
The linklocal address shown is an IPv6 address, which is writ
ten in hexadecimal.
...
more; some hold less.
 Nicer NAS systems will allow you to hotswap hard drives, meaning
that if one fails,
...
to a PC through a USB port, but that is primarily so you can use that PC to run the configuration software for the NAS. If you are running a small office and need additional local centralized storage, a NAS system is a good way to go.
...
There is no shortage of cloudbased storage providers on the market today.  Each one
offers slightly different features. Most of them will offer limited storage for free and
premium services for more dataheavy users or organizations.
...
these providers offer business plans with very high or unlimited storage as well for an additional fee.
...
Which one should you choose? If you want extra features such as webbased applications,
...
Nearly all client OSs will work with any of the cloudba sed storage providers, with the exception of Linux, which natively works only with
Dropbox.
...
their parameters with a webbased configuration utility or downloadable app.
While the
...
hamburger menu icon in the upperleft corner.
...
used by the router and adjust to match it. If the client does not, you will need to set it manually. A mismatched security mode will result in the inability to connect.
...
needs to know the right key to gain communication through a WEPenabled device.
The keys
...
t keys are supported by some vendors (WEP.64, WEP.128, and WEP.256). WEP.64 uses a
10- ch
...
security specification. Most notable among them was the use of the Temporal Key Integrity Protocol (TKIP). Whereas WEP used a static 64-  or 128- bit key,
 TKIP uses a 128- bit
dynamic perpacket key.
...
compliant.
WPA2 provides strong encryption and data protection, although it can be somewhat susceptible to bruteforce attacks, where passwords are rapidly guessed until the right
one is found.
...
Counter Mode Protection (AESGCMP) standard. It supports security keys of 128 bits and
256 bits in length.
...
they are bits per second (bps),
 kilobits per second (Kbps), megabits per second (Mbps), gigabits per second (Gbps), and terabits per second (Tbps). The exam objectives say Terabytes
per second is Tbps, but any acronym using bytes will have an uppercase B.
Understand what the common options are for Internet access. Options include dialup,
DSL,
 cable modems, fiberoptic Internet, satellite,
...
Know what five networking devices do. Modems are used to connect computers via telephone lines.
 Switches connect computers in a LAN. Access points are used in wireless networks to provide connectivity. Routers connect networks to each other, and firewalls are
...
designated as servers and others as clients or workstations, and peertopeer,
 where all computers are treated as equals.
...
factors. The standards are 802.11a/b/g/n/ac/ax. 802.11ax is the newest and fastest.
 Distance, radio frequency interference, and physical obstacles are factors that will cause signals
to attenuate faster.
