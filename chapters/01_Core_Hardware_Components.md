<!--
  noise-0: learn hub / chapters — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-1: curriculum / build pipeline — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-2: markdown / deep playground — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-3: chapters ties back to manifest in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-4: assets / operating systems — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-5: techplus ties back to runtime bundle in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-6: security / lesson depth — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-7: kali / banner sync — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-8: pentest / depth metadata — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-9: gimkit / learn hub — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-10: build pipeline / kali — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-11: html polish / tokens — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-12: segments / quizzes — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-13: banners / cloud — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-14: tokens / threat model — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-15: css layers / normalize — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-16: study mode ties back to html validation in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-17: deep playground / layout grid — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-18: freecodecamp / complete reference — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-19: comptia ties back to assets in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-20: lab procedures / html polish — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-21: quizzes / freecodecamp — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-22: tracks / editorial — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-23: split build / hardware — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-24: manifest / path helpers — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-25: editorial / capstone — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-26: readability / foreign ids — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-27: workplace / org view — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-28: cloud / curriculum — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-29: networking / pentest — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-30: database / css layers — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-31: operating systems ties back to tracks in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-32: hardware ties back to networking in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-33: peripherals / hands-on — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-34: continuity ties back to patch pass in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-35: threat model / pdf fixes — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-36: hands-on / playground wiring — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-37: markdown sources ties back to checklist in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-38: runtime bundle / techplus — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-39: path helpers / segments — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-40: chapter io ties back to comptia in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-41: audit scripts / readability — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-42: normalize / peripherals — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-43: patch pass / chapter io — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-44: import graph / quiz bank — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-45: lesson depth ties back to consistency sweep in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-46: capstone / study patch — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-47: quiz bank / markdown — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-48: slow curriculum / gimkit — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-49: html validation / study mode — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-50: pdf fixes / split build — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-51: voucher test / database — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-52: banner sync / markdown sources — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-53: foreign ids / import graph — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-54: consistency sweep / voucher test — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-55: teach skin / courses map — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-56: layout grid / editorial standard — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-57: playground wiring / security — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-58: courses map / banners — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-59: depth metadata / lab procedures — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-60: org view / workplace — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-61: study patch ties back to continuity in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-62: md chapter slice ties back to audit scripts in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-63: complete reference ties back to slow curriculum in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-64: checklist / teach skin — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-65: editorial standard / md chapter slice — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-66: learn hub / chapters — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-67: curriculum / build pipeline — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-68: markdown / deep playground — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-69: chapters ties back to manifest in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-70: assets / operating systems — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-71: techplus ties back to runtime bundle in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-72: security / lesson depth — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-73: kali / banner sync — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-74: pentest / depth metadata — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-75: gimkit / learn hub — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-76: build pipeline / kali — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-77: html polish / tokens — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-78: segments / quizzes — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-79: banners / cloud — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-80: tokens / threat model — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-81: css layers / normalize — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-82: study mode ties back to html validation in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-83: deep playground / layout grid — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-84: freecodecamp / complete reference — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-85: comptia ties back to assets in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-86: lab procedures / html polish — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-87: quizzes / freecodecamp — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-88: tracks / editorial — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-89: split build / hardware — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-90: manifest / path helpers — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-91: editorial / capstone — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-92: readability / foreign ids — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-93: workplace / org view — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-94: cloud / curriculum — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-95: networking / pentest — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-96: database / css layers — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-97: operating systems ties back to tracks in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-98: hardware ties back to networking in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-99: peripherals / hands-on — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-100: continuity ties back to patch pass in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-101: threat model / pdf fixes — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-102: hands-on / playground wiring — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-103: markdown sources ties back to checklist in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-104: runtime bundle / techplus — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-105: path helpers / segments — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-106: chapter io ties back to comptia in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-107: audit scripts / readability — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-108: normalize / peripherals — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-109: patch pass / chapter io — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-110: import graph / quiz bank — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-111: lesson depth ties back to consistency sweep in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-112: capstone / study patch — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-113: quiz bank / markdown — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-114: slow curriculum / gimkit — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-115: html validation / study mode — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-116: pdf fixes / split build — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-117: voucher test / database — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-118: banner sync / markdown sources — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-119: foreign ids / import graph — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-120: consistency sweep / voucher test — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-121: teach skin / courses map — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-122: layout grid / editorial standard — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-123: playground wiring / security — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-124: courses map / banners — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-125: depth metadata / lab procedures — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-126: org view / workplace — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-127: study patch ties back to continuity in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-128: md chapter slice ties back to audit scripts in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-129: complete reference ties back to slow curriculum in this repo slice (chapters/01_Core_Hardware_Components.md)
  noise-130: checklist / teach skin — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-131: editorial standard / md chapter slice — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-132: learn hub / chapters — mental map while skimming (chapters/01_Core_Hardware_Components.md)
  noise-133: curriculum / build pipeline — mental map while skimming (chapters/01_Core_Hardware_Components.md)
-->
...
Some of them are exclusively found inside the case, such as the motherboard and the processor, whereas others can be internal or external. For example, internal hard drives (for
...
In addition, they may have different power requirements. MicroATX and ITX are specifically designed to be paired with low- wattage power supplies, which consume and produce
...
Mini-ITX 2001 6.7 × 6.7 in (170 × 170 mm)
NanoITX 20
...
shows three PCI expansion slots; notice how the keys are in different positions on the connectors. The 5V slot is in the foreground and the two 3.3V slots are behind it. Also notice
...
These 22 pins comprise mostly voltage and ground leads. Figure 1.8 shows, from top to bottom, a × 16 slot, two × 1 slots, and a legacy PCI slot.
...
when the standard is released, people shake their heads at how mindbogglingly fast they
...
secured. Securing data in transit is covered more in Chapter 8, “Networking Concepts and Technologies,” and securing data at rest is in
...
into is called Integrated Drive Electronics (IDE) or Parallel Advanced Technology Attachment (PATA). The newer and much faster one is called Serial Advanced Technology Attachment (SATA). Figure 1.9 shows the two IDE connectors (the black and white ones are the
...
This special memory chip contains the BIOS system software that boots the system and initiates the memory and hard drive to allow the operating system to start.
The BIOS chip is easily identified. If you have a brandname computer,
 this chip might
...
system time, selecting a preferred boot device, or enabling/disabling features such as virtualization support or BIOS security and save the results. In the BIOS shown in Figure 1.13,
...
semiconductor (CMOS). CMOS (pronounced seemoss
) is actually a manufacturing technology for integrated circuits, but since the first commonly used chip made from CMOS
...
would reboot your computer from a cold startup without removing power from the components. The reset button is incredibly handy to have when a software application locks up
...
Trying to get to the back of your computer to plug in a flash drive is about as convenient as ripping out the back seat of your car to get stuff out of the trunk.

It might actually be faster just to remove your hard drive and give it to your friend so they
...
were in a configuration called a pin grid array (PGA). The newer version uses a configuration called the land grid array (LGA). LGA is sturdier than PGA because it has the pins in
...
used in devices that are tabletsized and smaller,
...
L2 cache, L3 cache, and RAM. This is also the typical decreasing order of speed. The following list includes representative capacities of these memory types. The cache capacities are
...
(OCT), and binary (BIN) conversions of the number. If you have an older version of Calculator, you will need to click the radio buttons next to these options to perform the
conversion. The number in binary is 100001011.
...
BIOS chips today are updatable through a process mentioned earlier called flashing the BIOS. BIOS chips are now stored on a newer,
modified version of ROM called electronically erasable programmable ROM (EEPROM), which allows the ROM to be updated by using
electronic pulses.
...
controlled by the system timer on the motherboard. (Remember the Northbridge? It controls all of that.) The system timer determines the speed at which data enters the processor.
Memory that operates at the same speed as the frontside bus is called single data r
ate (SDR)
synchronous dynamic randomaccess memory (SDRAM).
...
platters, each with a readwrite head on a retractable arm that reads data from and writes
...
You might hear oldti mers talk about floppy disks and floppy disk drives
...
1,000 bytes 1 kilobyte (KB) A 1,000-  character plaintext file or a small icon.
1,00
0 kilobytes 1 megabyte (MB) A small photograph or one minute of music.
1,000 megabytes 1 gigabyte (GB) A full-  length audio CD is about 800 MB; a twohour
DVD mo
vie is about 4 GB.
...
spin from one generation of drives to the next, with multiple speeds coexisting in the marketplace for an unpredictable period until demand dies down for one or more speeds.
...
Figure 1.22 shows the ends of the data cables. Again, the top one is PATA, and the bottom one is SATA. The connectors where the data cables plug into the motherboard were
...
which device has priority over the other. Otherwise, they fight like spoiled children and neither one will work. To do that, you need to configure each drive as either the primary or the
...
1. Open File Explorer in Windows 11 by pressing the Windows key on your keyboard
...
doubles the capacity of one side of the disc. Boldfaced capacities in the table are the commonly accepted values for their respective formats.
A doublesi ded, single- la yer DVD will give you more storage space than a
single- si
ded, dual- la
...
have their own onboard RAM. This is a good thing, and just like the RAM on your motherboard, the more the better. Figure 1.32 shows a video card.
...
cards (or audio cards). Although sound cards started out as pluggable adapters, this functionality is one of the most common integrated technologies found on motherboards today.
...
bus on the motherboard (PCIe, PCI, and so on) as well as a connector for the type of network (wired connectors such as fiber or RJ45, or an antenna for wireless). Figure 1.34 shows
...
tolerance.
Modems
Any computer that connects to the Internet using an analog dialup connection needs a
modem, or
...
advanced systems that employ powerhungry graphics technologies or multiple disk drives,
for instance.
 It is important to consider the draw that the various components and subcomponents of your computer place on the power supply before choosing one or its replacement.
...
Most power supplies have a recessed, twoposition slider switch, often a red one,  on the
...
however, the power supply receives more voltage than its setting. The result could be disastrous for the entire computer. Sparks could also ignite a fire that could destroy nearby property and endanger lives. Always check the switch before powering up a new or recently
...
adapter. You can see the circular connector on the laptop for the adapter. Many newer laptops use a power supply with a USB-C connector at the end instead of the older circular one.
...
called heat sinks are attached to a heatproducing component to dissipate the heat
more rapidly
.
...
- **Power Supply Exhaust Fan.** This fan is usually found at the back of the power supply and is used to cool the power supply.
...
exception. However, because of the large amount of heat produced, the CPU must have (proportionately) the largest surface area exposed to the moving air in the case. Therefore, the
...
in some cases, you might find that the heat sink extends up farther, using radiatortype fins, and
...
type of liquid cooler for a home PC is called an allinone (AIO) cooler.
 An AIO cooler will
be much smaller than an air cooler and has one to three fans installed. AIO systems are comparably priced to air coolers. There are other, fancier, and more expensive water cooling systems that require the user to buy separate components and put them all together.
...
Eight bits are 1 byte.
 Further, 1,000 bytes equal 1 kilobyte; 1,000 kilobytes equal 1 megabyte; 1,000 megabytes equal 1 gigabyte; 1,000 gigabytes equal 1 terabyte; and 1,000 terabytes equal 1 petabyte.
...
read/write heads, whereas SSDs use flash memory. SSDs are faster but generally more expensive than their conventional HDD counterparts. A newer SSD technology is NVMe, which
...
Know the features of optical discs. Optical discs store data but are not designed to
replace hard drives. BD-ROMs store more data than DVD-ROMs, which store more than
CD-ROMs.
...
4. If this laptop were for a relative who traveled a lot, would you change your recommendation and why?
