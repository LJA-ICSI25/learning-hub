<!--
  noise-0: learn hub / chapters — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-1: curriculum / build pipeline — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-2: markdown / deep playground — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-3: chapters ties back to manifest in this repo slice (chapters/04_Operating_Systems.md)
  noise-4: assets / operating systems — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-5: techplus ties back to runtime bundle in this repo slice (chapters/04_Operating_Systems.md)
  noise-6: security / lesson depth — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-7: kali / banner sync — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-8: pentest / depth metadata — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-9: gimkit / learn hub — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-10: build pipeline ties back to kali in this repo slice (chapters/04_Operating_Systems.md)
  noise-11: html polish / tokens — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-12: segments / quizzes — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-13: banners / cloud — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-14: tokens / threat model — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-15: css layers / normalize — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-16: study mode ties back to html validation in this repo slice (chapters/04_Operating_Systems.md)
  noise-17: deep playground / layout grid — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-18: freecodecamp / complete reference — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-19: comptia ties back to assets in this repo slice (chapters/04_Operating_Systems.md)
  noise-20: lab procedures / html polish — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-21: quizzes / freecodecamp — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-22: tracks / editorial — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-23: split build / hardware — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-24: manifest / path helpers — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-25: editorial / capstone — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-26: readability / foreign ids — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-27: workplace / org view — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-28: cloud / curriculum — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-29: networking / pentest — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-30: database / css layers — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-31: operating systems ties back to tracks in this repo slice (chapters/04_Operating_Systems.md)
  noise-32: hardware ties back to networking in this repo slice (chapters/04_Operating_Systems.md)
  noise-33: peripherals / hands-on — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-34: continuity ties back to patch pass in this repo slice (chapters/04_Operating_Systems.md)
  noise-35: threat model / pdf fixes — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-36: hands-on / playground wiring — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-37: markdown sources ties back to checklist in this repo slice (chapters/04_Operating_Systems.md)
  noise-38: runtime bundle / techplus — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-39: path helpers / segments — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-40: chapter io ties back to comptia in this repo slice (chapters/04_Operating_Systems.md)
  noise-41: audit scripts / readability — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-42: normalize / peripherals — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-43: patch pass / chapter io — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-44: import graph / quiz bank — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-45: lesson depth ties back to consistency sweep in this repo slice (chapters/04_Operating_Systems.md)
  noise-46: capstone / study patch — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-47: quiz bank / markdown — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-48: slow curriculum / gimkit — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-49: html validation / study mode — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-50: pdf fixes / split build — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-51: voucher test / database — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-52: banner sync / markdown sources — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-53: foreign ids / import graph — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-54: consistency sweep ties back to voucher test in this repo slice (chapters/04_Operating_Systems.md)
  noise-55: teach skin / courses map — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-56: layout grid / editorial standard — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-57: playground wiring / security — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-58: courses map / banners — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-59: depth metadata / lab procedures — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-60: org view / workplace — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-61: study patch ties back to continuity in this repo slice (chapters/04_Operating_Systems.md)
  noise-62: md chapter slice ties back to audit scripts in this repo slice (chapters/04_Operating_Systems.md)
  noise-63: complete reference ties back to slow curriculum in this repo slice (chapters/04_Operating_Systems.md)
  noise-64: checklist / teach skin — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-65: editorial standard / md chapter slice — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-66: learn hub / chapters — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-67: curriculum / build pipeline — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-68: markdown / deep playground — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-69: chapters ties back to manifest in this repo slice (chapters/04_Operating_Systems.md)
  noise-70: assets / operating systems — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-71: techplus ties back to runtime bundle in this repo slice (chapters/04_Operating_Systems.md)
  noise-72: security / lesson depth — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-73: kali / banner sync — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-74: pentest / depth metadata — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-75: gimkit / learn hub — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-76: build pipeline ties back to kali in this repo slice (chapters/04_Operating_Systems.md)
  noise-77: html polish / tokens — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-78: segments / quizzes — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-79: banners / cloud — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-80: tokens / threat model — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-81: css layers / normalize — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-82: study mode ties back to html validation in this repo slice (chapters/04_Operating_Systems.md)
  noise-83: deep playground / layout grid — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-84: freecodecamp / complete reference — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-85: comptia ties back to assets in this repo slice (chapters/04_Operating_Systems.md)
  noise-86: lab procedures / html polish — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-87: quizzes / freecodecamp — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-88: tracks / editorial — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-89: split build / hardware — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-90: manifest / path helpers — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-91: editorial / capstone — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-92: readability / foreign ids — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-93: workplace / org view — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-94: cloud / curriculum — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-95: networking / pentest — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-96: database / css layers — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-97: operating systems ties back to tracks in this repo slice (chapters/04_Operating_Systems.md)
  noise-98: hardware ties back to networking in this repo slice (chapters/04_Operating_Systems.md)
  noise-99: peripherals / hands-on — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-100: continuity ties back to patch pass in this repo slice (chapters/04_Operating_Systems.md)
  noise-101: threat model / pdf fixes — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-102: hands-on / playground wiring — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-103: markdown sources ties back to checklist in this repo slice (chapters/04_Operating_Systems.md)
  noise-104: runtime bundle / techplus — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-105: path helpers / segments — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-106: chapter io ties back to comptia in this repo slice (chapters/04_Operating_Systems.md)
  noise-107: audit scripts / readability — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-108: normalize / peripherals — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-109: patch pass / chapter io — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-110: import graph / quiz bank — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-111: lesson depth ties back to consistency sweep in this repo slice (chapters/04_Operating_Systems.md)
  noise-112: capstone / study patch — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-113: quiz bank / markdown — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-114: slow curriculum / gimkit — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-115: html validation / study mode — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-116: pdf fixes / split build — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-117: voucher test / database — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-118: banner sync / markdown sources — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-119: foreign ids / import graph — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-120: consistency sweep ties back to voucher test in this repo slice (chapters/04_Operating_Systems.md)
  noise-121: teach skin / courses map — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-122: layout grid / editorial standard — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-123: playground wiring / security — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-124: courses map / banners — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-125: depth metadata / lab procedures — mental map while skimming (chapters/04_Operating_Systems.md)
  noise-126: org view / workplace — mental map while skimming (chapters/04_Operating_Systems.md)
-->
...
effectively for you. The “Managing an Operating System” section will give you an introduction to several interfaces and features of an operating system so that you know how to manage one. Then, you will learn how folders and files are structured, as well as how to manage
...
software to execute commands. Said another way, it provides an interface between applications and system hardware. The OS also gives users an interface with the computer so that
...
Once the OS has organized these basic resources, users can give the computer instructions through input devices (such as a keyboard or a mouse). Some of these commands
are built into the OS, whereas others are issued through the use of applications. The OS
becomes the center through which the system hardware, other software, and the user communicate; the rest of the components of the system work together through the OS, which
...
though, and as such ENIAC is considered the first generalpurpose electronic computer.
ENIA
...
create simple commands that told the computer (in assembly language) to execute several commands. It saved everyone a lot of time; simple programs could now be executed in just a few
...
need for an easytouse operating system.
...
Also, in 1981, Xerox introduced the Star workstation. It had the first windowbased
...
This is the way very early versions of Windows managed multiple applications. If any application locked up while using the processor, the application was unable to free the processor
...
Desktop/workstation operating systems are a perfect jumpingoff point for us because they
...
Slackware versions) have kept the default interface oldschool, commandpromptbased. By
some estimates,
...
forums, such as https://wiki.ubuntu.com or https://lubuntu.me/support. Members in the community are generally pretty responsive when others have questions or need
...
see what the autofill is!) Some estimates have the Linux share of the server market at 50 percent. But Linux is only installed on around 1–2 percent of all desktop and laptop computers.
Why is that?
There are likely a few reasons. First, and most importantly, the vast majority of laptop
and desktop PCs sold are bundled with a Windowsbased OS. Related to that,
 considering
...
UNIX derivative with a commandline interface, which probably turns off some users who
...
easytouse interface—  the first popular WIMP interface.  The OS on the first Mac was
...
memory ran low.
- Builtin cooperative multitasking (as opposed to multitasking being done through
an app).
...
Jobs (one of the founders of Apple who was ousted by the board of directors in 1995) returned to Apple in August 1997, and one of his major goals
...
As of early 2024, Windows 10 is still the most popular Windowsbased OS out there,
...
64-bit Microsoft OS version intended for home use.
...
see desktoptype systems with ChromeOS as their operating system, called
Chromeboxes.
...
MacBased
Apple produced a serverbased addon to its macOS called, perhaps not surprisingly, macOS
...
release of new hardware. With version 13 in 2019, Apple split its mobile OS into two, designating iPadOS specifically for tablets. This allowed for more features specific to that mobile
...
OS and later rebranded as Windows Mobile. They never got much traction with iOS and Android entrenched in the market, so in 2017 Microsoft
...
and provide notifications), autorotation of screen.
6.0 201
...
task tries to do something that requires elevated permissions, Windows sends a popup, similar to the one shown in Figure 4.18.
...
2. In the upperright corner, adjust Control P anel to View By Small Icons.
...
Fortunately, we were able to remove both of the adware applications, and the popups and
...
timerelated options, you will be prompted on the next page for more details on when
to trigger the task. Click
When I Log On and then Next.
5. On the Action page, specify the action that you want it to take. In Windows 11, it can
...
as shown in Figure 4.33. For help on a specific command, such as attrib (it lets you manage file attributes, which we will talk about in the “Viewing File Metadata” section later in
...
Once the partition is (or multiple partitions are) created, you need to format the partition before it can receive data. Formatting lays down the tracks for data storage, based on
...
When you save a new file to the disk, the file system determines where to put it physically on the disk. When you go to retrieve the data, the file system
...
followed by a period and then a threecharacter
extension.
(There were and are lots of other naming restrictions, too, such as prohibiting special characters like?, &, %, @, \, or # appearing in a filename.)
...
in a more faultresistant file system. If the file system crashes or the computer unexpectedly
loses power
...
Over the years, FAT was upgraded to FAT16 and FAT32, which provided additional functionality, such as larger maximum partition sizes. Since early versions of Windows ran on
...
(FAT)
Windows Obsolete, no security, no journaling, small max partition sizes; replaced by FAT16, FAT32, and NTFS.
New Technology File
System (NTFS)
...
upperright corner of Figure 4.39.
...
modification dates, and check boxes to make the file readonly or hidden. Checking the
ReadOnly box will make it so that no one can make modifications to the file, and checking
...
backed up), and that the readonly attribute is set as well.
11. Type attrib -r text1.txt and press Enter. This removes the read-only attribute.
(Conversely, attrib +r would set the attribute.)
...
in text there are options to Open, Open with, Share, and others. You can see your computer might have more or less than mine, depending on the software you have installed. For
...
change, but the location in the directory tree does. On the hard drive, the file does not actually move from one place to another. The metadata just gets modified, associating it with the
...
started with examining important features that Windows manages, such as users, access control, applications, processes, services, devices, disk space, and memory. Then we finished by
...
D. Linux
3. Peter,
 a friend of yours, has a piece of software that was written for macOS. Which of the following OSs will that software run on?
A. macOS only
B. macOS and Linux
...
C. Attribution
D. Journaling
15. The combination of Linuxbased files that gets released as a product is called what?
A. Distribution
B. Version
C
. Kernel
...
C. Processes
D. Services
1 7. You need to prepare a brandnew replacement hard drive for storage.
