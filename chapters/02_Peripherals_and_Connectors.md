<!--
  noise-0: learn hub / chapters — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-1: curriculum / build pipeline — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-2: markdown / deep playground — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-3: chapters ties back to manifest in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-4: assets / operating systems — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-5: techplus ties back to runtime bundle in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-6: security / lesson depth — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-7: kali / banner sync — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-8: pentest / depth metadata — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-9: gimkit / learn hub — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-10: build pipeline / kali — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-11: html polish / tokens — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-12: segments / quizzes — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-13: banners / cloud — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-14: tokens / threat model — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-15: css layers / normalize — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-16: study mode ties back to html validation in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-17: deep playground / layout grid — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-18: freecodecamp / complete reference — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-19: comptia ties back to assets in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-20: lab procedures / html polish — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-21: quizzes / freecodecamp — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-22: tracks / editorial — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-23: split build / hardware — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-24: manifest / path helpers — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-25: editorial / capstone — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-26: readability / foreign ids — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-27: workplace ties back to org view in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-28: cloud / curriculum — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-29: networking ties back to pentest in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-30: database / css layers — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-31: operating systems / tracks — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-32: hardware / networking — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-33: peripherals ties back to hands-on in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-34: continuity ties back to patch pass in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-35: threat model / pdf fixes — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-36: hands-on / playground wiring — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-37: markdown sources ties back to checklist in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-38: runtime bundle / techplus — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-39: path helpers / segments — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-40: chapter io ties back to comptia in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-41: audit scripts / readability — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-42: normalize / peripherals — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-43: patch pass / chapter io — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-44: import graph / quiz bank — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-45: lesson depth ties back to consistency sweep in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-46: capstone / study patch — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-47: quiz bank / markdown — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-48: slow curriculum / gimkit — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-49: html validation / study mode — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-50: pdf fixes / split build — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-51: voucher test / database — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-52: banner sync / markdown sources — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-53: foreign ids / import graph — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-54: consistency sweep / voucher test — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-55: teach skin / courses map — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-56: layout grid / editorial standard — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-57: playground wiring ties back to security in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-58: courses map / banners — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-59: depth metadata / lab procedures — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-60: org view / workplace — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-61: study patch ties back to continuity in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-62: md chapter slice ties back to audit scripts in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-63: complete reference ties back to slow curriculum in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-64: checklist / teach skin — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-65: editorial standard / md chapter slice — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-66: learn hub / chapters — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-67: curriculum / build pipeline — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-68: markdown / deep playground — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-69: chapters ties back to manifest in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-70: assets / operating systems — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-71: techplus ties back to runtime bundle in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-72: security / lesson depth — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-73: kali / banner sync — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-74: pentest / depth metadata — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-75: gimkit / learn hub — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-76: build pipeline / kali — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-77: html polish / tokens — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-78: segments / quizzes — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-79: banners / cloud — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-80: tokens / threat model — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-81: css layers / normalize — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-82: study mode ties back to html validation in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-83: deep playground / layout grid — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-84: freecodecamp / complete reference — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-85: comptia ties back to assets in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-86: lab procedures / html polish — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-87: quizzes / freecodecamp — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-88: tracks / editorial — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-89: split build / hardware — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-90: manifest / path helpers — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-91: editorial / capstone — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-92: readability / foreign ids — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
  noise-93: workplace ties back to org view in this repo slice (chapters/02_Peripherals_and_Connectors.md)
  noise-94: cloud / curriculum — mental map while skimming (chapters/02_Peripherals_and_Connectors.md)
-->
...
audio input, which one is for speakers (it's usually green), and which one is for the microphone (usually pink).
...
away from the system. The inherent challenge to this is that ambient light tends to interfere with the image's projection. The best way to fight this problem is to ensure that your
...
. (The exam objectives also call it high-definition media interface, but the difference is unimportant.) It was introduced in 2002,
...
Now if you said that high- speed, ultrahighcapacity external storage was relatively new
...
gravitated towards easytouse flash drives. If your system doesn't have a memory card
...
Version Year Speed Port/color T rade name
...
find Thunderbolt ports as standard features on Apple laptops, but they are hitormiss on
other brands.
...
easytouse, hotpluggable (you can plug in or unplug a device while the power is on) connector
...
though, when offtheshelf solutions don't work.
...
supply can help resolve lossofpower issues as well as help protect from damaging power surges.
...
you can open through Control Panel. It's not so important how you get there
...
From a printquality standpoint, it doesn't matter that much which configuration you
...
Figure 2.43 shows a small laser printer's toner carriage with four cartridges—  black, cyan,
...
shows the male DE9. It's aqua colored and conveniently labeled “Serial.”
...
driver. When an operating system does this, it's referred to as plugandpla
y. Literally, you
plug the device in and you can play. If not, you will need to install the driver manually. You
might have gotten it on a CD or flash drive, or you may need to download it from the Internet. I'll talk about drivers a lot more in Chapter 5.
...
too. Then let plugandplay do its thing. In fact,
 installing an external device is really the
type of scenario for which plugandplay was designed. Using
...
require IP-  or webbased configuration steps. Let's take a quick look at each.
IP- Based Printers
...
WebBased Printers
Several printer manufacturers allow you to configure a printer to be available via the Internet or by sending it an email. For example, many HP printers are compatible with HP ePrint,
...
home! Granted, you won't be there to see it, but it's still pretty cool. If you have an HP
...
(which I'll cover in more detail in Chapter 5), plugandplay,
 and the steps required for IP-based peripherals and webbased configuration.
Exam Essentials
...
driver (or let plugandplay install it), and configure the device.
Chapter 2 Lab
...
. RJ45
D. Bluetooth
9. If you are installing a peripheral device and plugandplay works as expected, which of the
following is true?
A
