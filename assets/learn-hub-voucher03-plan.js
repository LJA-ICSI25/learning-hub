/**
 * Tech+ Voucher Test 03 — maps each question index to an FC0-U71 objective strip (1–12),
 * same weighting model as Voucher 01 for consistent study analytics.
 */
window.LEARN_HUB_VOUCHER03_PLAN = {
  setId: "tech-voucher-test-03",
