...
const coursesSrc = fs.readFileSync(path.join(root, "learn-hub-courses.js"), "utf8");
const depthSrc = fs.readFileSync(path.join(root, "learn-hub-depth.js"), "utf8");
...
fs.writeFileSync(path.join(root, "learn-hub-courses.js"), outCourses, "utf8");
...
fs.writeFileSync(path.join(root, "learn-hub-depth.js"), outDepth, "utf8");
