...
need for an easyto- use operating system.
...
Slackware versions) have kept the default interface oldschool, commandprompt- based. By
some estimates,
...
easyto- use interface—  the first popular WIMP interface.  The OS on the first Mac was
...
touchscreen that you could use with your fingers and not a stylus, and it used pinchto- zoom
