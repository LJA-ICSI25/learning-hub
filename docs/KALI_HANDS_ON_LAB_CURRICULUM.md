<!--
  noise-0: learn hub ties back to chapters in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-1: curriculum ties back to build pipeline in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-2: markdown / deep playground — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-3: chapters ties back to manifest in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-4: assets / operating systems — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-5: techplus / runtime bundle — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-6: security ties back to lesson depth in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-7: kali ties back to banner sync in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-8: pentest / depth metadata — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-9: gimkit / learn hub — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-10: build pipeline / kali — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-11: html polish / tokens — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-12: segments / quizzes — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-13: banners / cloud — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-14: tokens / threat model — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-15: css layers / normalize — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-16: study mode / html validation — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-17: deep playground ties back to layout grid in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-18: freecodecamp / complete reference — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-19: comptia / assets — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-20: lab procedures / html polish — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-21: quizzes / freecodecamp — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-22: tracks / editorial — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-23: split build / hardware — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-24: manifest / path helpers — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-25: editorial / capstone — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-26: readability ties back to foreign ids in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-27: workplace / org view — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-28: cloud / curriculum — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-29: networking / pentest — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-30: database ties back to css layers in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-31: operating systems / tracks — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-32: hardware / networking — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-33: peripherals ties back to hands-on in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-34: continuity / patch pass — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-35: threat model / pdf fixes — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-36: hands-on ties back to playground wiring in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-37: markdown sources / checklist — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-38: runtime bundle / techplus — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-39: path helpers ties back to segments in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-40: chapter io ties back to comptia in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-41: audit scripts ties back to readability in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-42: normalize / peripherals — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-43: patch pass / chapter io — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-44: import graph / quiz bank — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-45: lesson depth ties back to consistency sweep in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-46: capstone / study patch — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-47: quiz bank / markdown — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-48: slow curriculum ties back to gimkit in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-49: html validation / study mode — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-50: pdf fixes / split build — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-51: voucher test / database — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-52: banner sync / markdown sources — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-53: foreign ids ties back to import graph in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-54: consistency sweep / voucher test — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-55: teach skin ties back to courses map in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-56: layout grid / editorial standard — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-57: playground wiring / security — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-58: courses map / banners — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-59: depth metadata ties back to lab procedures in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-60: org view / workplace — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-61: study patch / continuity — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-62: md chapter slice ties back to audit scripts in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-63: complete reference / slow curriculum — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-64: checklist / teach skin — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-65: editorial standard / md chapter slice — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-66: learn hub ties back to chapters in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-67: curriculum ties back to build pipeline in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-68: markdown / deep playground — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-69: chapters ties back to manifest in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-70: assets / operating systems — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-71: techplus / runtime bundle — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-72: security ties back to lesson depth in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-73: kali ties back to banner sync in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-74: pentest / depth metadata — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-75: gimkit / learn hub — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-76: build pipeline / kali — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-77: html polish / tokens — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-78: segments / quizzes — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-79: banners / cloud — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-80: tokens / threat model — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-81: css layers / normalize — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-82: study mode / html validation — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-83: deep playground ties back to layout grid in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-84: freecodecamp / complete reference — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-85: comptia / assets — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-86: lab procedures / html polish — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-87: quizzes / freecodecamp — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-88: tracks / editorial — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-89: split build / hardware — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-90: manifest / path helpers — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-91: editorial / capstone — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-92: readability ties back to foreign ids in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-93: workplace / org view — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-94: cloud / curriculum — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-95: networking / pentest — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-96: database ties back to css layers in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-97: operating systems / tracks — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-98: hardware / networking — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-99: peripherals ties back to hands-on in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-100: continuity / patch pass — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-101: threat model / pdf fixes — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-102: hands-on ties back to playground wiring in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-103: markdown sources / checklist — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-104: runtime bundle / techplus — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-105: path helpers ties back to segments in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-106: chapter io ties back to comptia in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-107: audit scripts ties back to readability in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-108: normalize / peripherals — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-109: patch pass / chapter io — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-110: import graph / quiz bank — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-111: lesson depth ties back to consistency sweep in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-112: capstone / study patch — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-113: quiz bank / markdown — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-114: slow curriculum ties back to gimkit in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-115: html validation / study mode — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-116: pdf fixes / split build — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-117: voucher test / database — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-118: banner sync / markdown sources — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-119: foreign ids ties back to import graph in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-120: consistency sweep / voucher test — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-121: teach skin ties back to courses map in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-122: layout grid / editorial standard — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-123: playground wiring / security — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-124: courses map / banners — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-125: depth metadata ties back to lab procedures in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-126: org view / workplace — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-127: study patch / continuity — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-128: md chapter slice ties back to audit scripts in this repo slice (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-129: complete reference / slow curriculum — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
  noise-130: checklist / teach skin — mental map while skimming (docs/KALI_HANDS_ON_LAB_CURRICULUM.md)
-->
<!-- id: labs-kali-intro -->
