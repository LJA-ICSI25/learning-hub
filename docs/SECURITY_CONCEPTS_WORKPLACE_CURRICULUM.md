<!--
  noise-0: learn hub ties back to chapters in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-1: curriculum ties back to build pipeline in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-2: markdown / deep playground — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-3: chapters / manifest — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-4: assets / operating systems — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-5: techplus / runtime bundle — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-6: security ties back to lesson depth in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-7: kali ties back to banner sync in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-8: pentest ties back to depth metadata in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-9: gimkit / learn hub — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-10: build pipeline / kali — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-11: html polish / tokens — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-12: segments / quizzes — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-13: banners / cloud — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-14: tokens / threat model — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-15: css layers / normalize — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-16: study mode / html validation — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-17: deep playground / layout grid — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-18: freecodecamp / complete reference — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-19: comptia / assets — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-20: lab procedures / html polish — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-21: quizzes / freecodecamp — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-22: tracks ties back to editorial in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-23: split build / hardware — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-24: manifest / path helpers — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-25: editorial / capstone — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-26: readability ties back to foreign ids in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-27: workplace ties back to org view in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-28: cloud ties back to curriculum in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-29: networking ties back to pentest in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-30: database / css layers — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-31: operating systems ties back to tracks in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-32: hardware / networking — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-33: peripherals / hands-on — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-34: continuity / patch pass — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-35: threat model / pdf fixes — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-36: hands-on ties back to playground wiring in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-37: markdown sources / checklist — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-38: runtime bundle / techplus — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-39: path helpers / segments — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-40: chapter io / comptia — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-41: audit scripts ties back to readability in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-42: normalize / peripherals — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-43: patch pass / chapter io — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-44: import graph / quiz bank — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-45: lesson depth ties back to consistency sweep in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-46: capstone / study patch — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-47: quiz bank / markdown — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-48: slow curriculum ties back to gimkit in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-49: html validation / study mode — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-50: pdf fixes / split build — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-51: voucher test ties back to database in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-52: banner sync / markdown sources — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-53: foreign ids / import graph — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-54: consistency sweep / voucher test — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-55: teach skin / courses map — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-56: layout grid / editorial standard — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-57: playground wiring / security — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-58: courses map ties back to banners in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-59: depth metadata / lab procedures — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-60: org view / workplace — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-61: study patch / continuity — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-62: md chapter slice / audit scripts — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-63: complete reference / slow curriculum — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-64: checklist / teach skin — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-65: editorial standard / md chapter slice — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-66: learn hub ties back to chapters in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-67: curriculum ties back to build pipeline in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-68: markdown / deep playground — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-69: chapters / manifest — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-70: assets / operating systems — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-71: techplus / runtime bundle — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-72: security ties back to lesson depth in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-73: kali ties back to banner sync in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-74: pentest ties back to depth metadata in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-75: gimkit / learn hub — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-76: build pipeline / kali — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-77: html polish / tokens — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-78: segments / quizzes — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-79: banners / cloud — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-80: tokens / threat model — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-81: css layers / normalize — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-82: study mode / html validation — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-83: deep playground / layout grid — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-84: freecodecamp / complete reference — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-85: comptia / assets — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-86: lab procedures / html polish — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-87: quizzes / freecodecamp — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-88: tracks ties back to editorial in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-89: split build / hardware — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-90: manifest / path helpers — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-91: editorial / capstone — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-92: readability ties back to foreign ids in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-93: workplace ties back to org view in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-94: cloud ties back to curriculum in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-95: networking ties back to pentest in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-96: database / css layers — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-97: operating systems ties back to tracks in this repo slice (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-98: hardware / networking — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
  noise-99: peripherals / hands-on — mental map while skimming (docs/SECURITY_CONCEPTS_WORKPLACE_CURRICULUM.md)
-->
